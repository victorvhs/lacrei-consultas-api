        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "forma",
                    models.CharField(
                        choices=[("PIX", "PIX"), ("BOLETO", "Boleto"), ("ESCOLHA_DO_PAGADOR", "Escolha do Pagador")],
                        default="PIX",
                        max_length=32,
                    ),
                ),  # noqa: E501
                ...
                (
                    "pagador",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="pagamentos", to="payments.pagador"
                    ),
                ),  # noqa: E501
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pagamento",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="repasses", to="payments.pagamento"
                    ),
                ),  # noqa: E501
                (
                    "profissional",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo",
                    models.CharField(
                        choices=[("CRIAR_COBRANCA", "Criar Cobrança"), ("SOLICITAR_ESTORNO", "Solicitar Estorno")],
                        max_length=32,
                    ),
                ),  # noqa: E501
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="outbox_mensagens",
                        to="payments.pagamento",
                    ),
                ),  # noqa: E501
            ],
            options={
